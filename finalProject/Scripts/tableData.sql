...
INSERT INTO task (task_id, task_name, start_date, end_date, priority, parent_id, content, progress, backgroundcolor, textcolor, user_id, project_id)
VALUES ('TSK_'||TO_CHAR(task_seq.nextval, 'FM0000'), '로그인', TO_DATE('2024-07-28', 'YYYY-MM-DD'), TO_DATE('2024-08-30', 'YYYY-MM-DD'), '상', NULL, '로그인 전체', 10, 'blue', 'black', 'M_0003', 'PRO_0001');
