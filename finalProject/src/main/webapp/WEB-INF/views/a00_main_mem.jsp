...
<jsp:include page="a00_sideBar.jsp"/>	
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
                ...
                <img src="${path}/adminkit-3.1.0/static/img/avatars/avatar.jpg" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-dark">Welcome, MEM_${user_name}</span>
              </a>
