							...
							<div class="card-body">
								<div class="m-sm-4">
									<div class="text-center">
										<img src="${path}/adminkit-3.1.0/static/img/avatars/avatar.jpg" alt="Charles Hall" class="img-fluid rounded-circle" width="132" height="132" />
									</div>
									<form>
										<div class="mb-3">
										...
										<div class="mb-3">
											...
											<small>
            <a href="${path}/adminkit-3.1.0/static/index.html">Forgot password?</a>
          </small>
										</div>
										<div>
            ...
            <span class="form-check-label">
              Remember me next time
										...
										<div class="text-center mt-3">
											<a href="${path}/adminkit-3.1.0/static/index.html" class="btn btn-lg btn-primary">Sign in</a>
