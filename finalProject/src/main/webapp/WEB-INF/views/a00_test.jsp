...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="${pageContext.request.contextPath}/material-dashboard-2/assets/img/apple-icon.png">
  <link rel="icon" type="image/png" href="${pageContext.request.contextPath}/material-dashboard-2/assets/img/favicon.png">
  <title>
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
        <img src="${pageContext.request.contextPath}/material-dashboard-2/assets/img/logo-ct.png" class="navbar-brand-img h-100" alt="main_logo">
