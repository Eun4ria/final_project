			...
			<div id="content">
				...
				<div class="content">
					...
					<form method="post">
						<div class="">
							<div class="div01">
								<span class=""><fmt:message key="title" /> : </span> <input
									type="text" name="title" class="input01"
						...
						<div class="">
							<div class="div01">
								...
								</span> <input name="receiver" class="input01"
									placeholder="<fmt:message key="receiver"/>" />
							</div>
						</div>
						<div class="">
							<div class="div01">
								<span class=""><fmt:message key="sender" /> : </span> <input
									name="sender" class="input01" value="amjunha106@gmail.com"
									readonly />
							</div>
						</div>
						<div class="">
