	...
	<div class="input-group mb-3">	
		...
		function download(fname){
			if(confirm(fname+"다운로드 하시겠습니까?")){
				location.href="downLoad02.do?fname="+fname
			}
		}
	...
	<script type="text/javascript">
		$("#repBtn").click(function(){
			if(confirm("답글을 등록하시겠습니까?")){
				...
				$("form").attr("action","boardInsertFrm02.do")
				$("form").submit()
		...
		$("#uptBtn").click(function(){
			if(confirm("수정하시겠습니까?")){
				...
				$("form").attr("action","boardUpdate02.do");
				$("form").submit()
			}
		})
		$("#delBtn").click(function(){
			location.href="boardDelete02.do?no="+$("[name=no]").val();
		})		
